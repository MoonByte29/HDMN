        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#services" className="text-gray-400 hover:text-primary-400 transition-colors">Social Media Marketing</a></li>
              <li><a href="#services" className="text-gray-400 hover:text-primary-400 transition-colors">SEO Optimization</a></li>
              <li><a href="#services" className="text-gray-400 hover:text-primary-400 transition-colors">Graphic Designing</a></li>
              <li><a href="#services" className="text-gray-400 hover:text-primary-400 transition-colors">App Development</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start">
                <Clock className="w-5 h-5 text-primary-400 mt-1 mr-3" />
